...
class GloabTitleAndDetailImageCell: UITableViewCell {
    ...
    override func updateConstraints() {
        if !self.didMakeConstraints {
            ...
            detailLabel.snp.makeConstraints({ (make) in
                make.right.equalTo(self.detailImage.snp.left).offset(-10)
                make.centerY.equalTo(self.contentView.snp.centerY).offset(0)
            })
...
class GloabTitleAndImageCell: UITableViewCell {
    ...
    func setData(_ title:String, isSelect:Bool) {
        titleLabel.text = title
        if isSelect {
    ...
    func updateImageView(_ isSelect:Bool){
        if isSelect {
            detailImage.image = UIImage.init(named: "Checkbox_Selected")
        }else{
            detailImage.image = UIImage.init(named: "Checkbox_Normal")
...
class GloabImageTitleAndImageCell: UITableViewCell {
    ...
    func setData(_ title:String, infoImage:UIImage) {
        self.titleLabel.text = title
    ...
    override func updateConstraints() {
        if !self.didMakeConstraints {
            titleLabel.snp.makeConstraints({ (make) in
                make.left.equalTo(self.infoImageView.snp.right).offset(9)
                make.centerY.equalTo(self.contentView.snp.centerY).offset(0)
            })
...
class GloabTitleAndSwitchBarTableViewCell: UITableViewCell {
    ...
    func setTitleLabel(_ title:String, isSelect:Bool){
        titleLabel.text = title
...
class GloabTitleNumberCountTableViewCell: UITableViewCell {
    ...
    func setUpView() {
        ...
        numberTickView = NumberTickView.init(frame: CGRect(x: 15, y: 56, width: SCREENWIDTH - 30, height: 41), buttonWidth: 70, type: .sell, remainCount: nil)
...
class GloabTitleAndTextFieldCell: UITableViewCell {
    ...
    func setData(_ title:String,  plachString:String, textFieldText:String) {
        titleLabel.text = title
    ...
    func setText(_ title:String, plachString:String, textFieldText:String){
        titleLabel.text = title
        textField.placeholder = plachString
