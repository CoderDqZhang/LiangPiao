...
extension FMDatabase {
    ...
    func dateForQuery(_ sql: String, _ values: AnyObject...) -> NSDate! {
        return valueForQuery(sql, values: values) { $0.date(forColumnIndex: 0)! as NSDate }
    }
    ...
    func dataForQuery(_ sql: String, _ values: AnyObject...) -> NSData! {
        return valueForQuery(sql, values: values) { $0.data(forColumnIndex: 0)! as NSData }
    }
}
